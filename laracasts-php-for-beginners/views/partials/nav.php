                            ...
                            <button type="button"
                                ...
                                <?php if($_SESSION['user'] ?? false) : ?>
                                    ...
                                    <form method="POST" action="/session" class="ml-3">
                                        ...
                                        <button type="submit" class=" text-white hover:bg-gray-700 hover:text-white ml-2 px-3 py-2 rounded-md text-sm font-medium">
                                            Log Out
                                        </button>
                                    </form>
                                ...
                                <?php else : ?>
                                    ...
                                    <a href="/login"
                                        class="<?= urlIs('/login') ? 'bg-gray-900 text-white' : 'text-gray-300'; ?> hover:bg-gray-700 hover:text-white ml-2 px-3 py-2 rounded-md text-sm font-medium">Log In</a>
                                <?php endif; ?>
                            </button>
                        </div>
                    </div>
